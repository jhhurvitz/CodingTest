...
builder.Services.AddWeatherRepository(new WeatherConfiguration("https://api.openweathermap.org/", "{your api key here}")); //this would come from config in real application
